    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            {{-- <a class="navbar-brand" href="#"><img src="{{ asset('images/logo.png') }}" height="40px" width="70px"
                    alt=""></a> --}}
            <a class="navbar-brand @if ($pageSlug == 'accueil') {{ 'active' }} @endif" href="/degrevement/index">Accueil</a>
                ...
                <div class="d-flex">
                    <div class="nav-item dropdown dropstart">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark bg-dark " aria-labelledby="user">
                            <li><a class="dropdown-item @if ($pageSlug == 'profile') {{ 'active' }} @endif" href="/degrevement/profile">Profile</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="/degrevement/logout">Déconnexion</a></li>
                        </ul>
                    </div>
                </div>
            </div>
