                ...
                <form action="{{ url('update', $fiche) }}" role="form" method="post" class="form">
                    ...
                    <div class="col mb-2 d-flex justify-content-between">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="status" id="pcb" value="Favorable" @if ($fiche->status == "Favorable") checked   @endif>
                            <label class="form-check-label" for="pcb">Favorable</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="status" id="pcp"
                                value="Defavorable" @if ($fiche->status == "Defavorable") checked     @endif>
                            <label class="form-check-label" for="pcp">Defavorable</label>
                        </div> 
                    </div>
                <textarea class="form-control textarea mb-2" aria-label="With textarea" name="obs_cd_si"  >{{ $fiche->obs_cd_si }} </textarea>
