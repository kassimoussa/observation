                    ...
                    <div class="row mb-2 ">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body"> 
                                    <textarea class="form-control textarea mb-2" aria-label="With textarea" name="obs_nv2" readonly >{{ $fiche->obs_nv2 }} </textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-2 ">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <h4 class="card-header  text-center bg-dark text-white">Commentaire</h4>
                                <div class="card-body">
                                    <textarea class="form-control textarea mb-2" aria-label="With textarea" name="obs_nv3" readonly >{{ $fiche->obs_nv3 }} </textarea>
                                </div>
                            </div>
                        </div>
                    </div>
